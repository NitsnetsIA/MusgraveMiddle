    ...
    <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold" data-testid="text-page-title">
              Sistema PIM - Gestión de Productos
            </h1>
            <p className="text-muted-foreground">
              Sistema completo de gestión de productos de alimentación con IVA español
            </p>
          </div>
        </div>
      ...
      <Tabs defaultValue="view-data" className="w-full">
        ...
        <TabsContent value="view-data" className="mt-6">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            {/* Add Delete All buttons for Purchase Orders and Orders */}
            <div className="flex justify-end gap-2 mt-4 mb-6">
              ...
              {activeTab === 'orders' && (
                <Button
                  ...
                  data-testid="button-delete-all-orders-tab"
                >
      ...
      <Card className="mb-8">
        ...
        <TabsContent value="generate-data" className="mt-6">
          {/* All generation content will be moved here later */}
          <div className="text-center py-8">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="products" className="mt-6">
            ...
            {/* Add other TabsContent for users, purchase-orders, orders, and taxes here */}
          </Tabs>
        </TabsContent>
